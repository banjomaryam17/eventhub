    ...
    icon: (
      ...
      >
        ...
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={1.5}
          d="M11.5 21C11.5 21 6 16.5 6 12s5.5-9 5.5-9M12.5 21C12.5 21 18 16.5 18 12S12.5 3 12.5 3M3 12h18"
        />
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        ...
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={1.5}
          d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10l1 1h10l1-1zm0 0V8h4l2 5v3h-6z"
        />
      </svg>
    ),
  },
    ...
    <Link href={`/listings/${listing.id}`} className="group block">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden hover:border-slate-600 hover:shadow-xl hover:shadow-black/30 transition-all duration-200">
        <div className="aspect-square bg-slate-800 flex items-center justify-center relative overflow-hidden">
          ...
          <span
            className={`absolute top-3 left-3 text-xs font-semibold px-2 py-0.5 rounded-full ${conditionColor}`}
          >
            {listing.condition}
          </span>
        </div>
                ...
                <>
                  {user ? (
                    <>
                      ...
                      <Link
                        href="/sell/new"
                        className="hidden sm:flex items-center gap-1.5 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium px-4 py-2 rounded-xl transition-colors"
                      >
                        <svg
                          className="w-4 h-4"
                          fill="none"
                      ...
                      <Link
                        href="/orders"
                        className="text-slate-400 hover:text-white text-sm px-3 py-2 rounded-xl hover:bg-slate-800 transition-colors hidden sm:block"
                      >
                        Orders
                      </Link>
                      {/* Cart with badge */}
                      <Link
                        href="/cart"
                        className="relative text-slate-400 hover:text-white p-2 rounded-xl hover:bg-slate-800 transition-colors"
                      >
                        <svg
                          className="w-5 h-5"
                          fill="none"
                      ...
                      <div className="flex items-center gap-2 pl-2 border-l border-slate-700">
                        <Link
                          href="/profile"
                          className="w-8 h-8 rounded-full bg-indigo-600/20 border border-indigo-500/30 flex items-center justify-center hover:border-indigo-400 transition-colors"
                        >
                    ...
                    <>
                      <Link
                        href="/auth/login"
                        className="text-slate-400 hover:text-white text-sm px-3 py-2 rounded-xl hover:bg-slate-800 transition-colors"
                      >
                        Sign in
                      </Link>
                      <Link
        ...
        <div className="bg-amber-500/10 border-b border-amber-500/20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between flex-wrap gap-3">
            ...
            <div className="flex items-center gap-2">
              <Link
                href="/admin"
                className="text-xs bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 px-3 py-1.5 rounded-lg transition-colors font-medium"
              >
                Admin Dashboard
              </Link>
              <Link
        ...
        <section className="relative overflow-hidden border-b border-slate-800/60">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 text-center">
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto mb-10">
              Discover unique items from sellers in your area. Buy with
              confidence, sell with ease.
            </p>
            <form
              onSubmit={handleSearch}
              className="flex gap-2 max-w-lg mx-auto sm:hidden mb-6"
            >
              <input
                type="text"
                placeholder="Search listings..."
              ...
              <button
                type="submit"
                className="bg-indigo-600 hover:bg-indigo-500 text-white px-4 py-3 rounded-xl text-sm font-medium transition-colors"
              >
                Search
              </button>
            </form>
            <div className="flex items-center justify-center gap-4 flex-wrap">
              ...
              {user ? (
                <Link
                  href="/sell/new"
                  className="border border-slate-700 hover:border-slate-500 text-white font-medium px-6 py-3 rounded-xl transition-colors hover:bg-slate-800"
                >
                  + Create listing
                </Link>
              ) : (
            ...
            <div className="bg-gradient-to-r from-indigo-600/20 to-teal-600/20 border border-indigo-500/20 rounded-2xl p-8 flex items-center justify-between flex-wrap gap-6">
              <div>
                ...
                <p className="text-slate-400 text-sm">
                  Create a listing in under 2 minutes and reach buyers today.
                </p>
              </div>
              <Link
                href="/sell/new"
                className="bg-indigo-600 hover:bg-indigo-500 text-white font-medium px-6 py-3 rounded-xl transition-colors flex-shrink-0"
              >
                + Create listing
              </Link>
            </div>
