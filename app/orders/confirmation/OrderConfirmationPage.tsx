      ...
      <div className="max-w-md mx-auto text-center py-16">
        ...
        {status === "success" && (
          <Card className="flex flex-col items-center gap-5">
            ...
            <div className="w-full border-t border-slate-800 pt-5 flex flex-col gap-3">
              <Button href="/orders" fullWidth>View my orders</Button>
              <Button href="/listings" variant="secondary" fullWidth>Continue shopping</Button>
            </div>
          </Card>
        )}
        ...
        {status === "failed" && (
          <Card className="flex flex-col items-center gap-5">
            ...
            <div className="w-full border-t border-slate-800 pt-5 flex flex-col gap-3">
              <Button href="/checkout" fullWidth>Try again</Button>
              <Button href="/cart" variant="secondary" fullWidth>Back to cart</Button>
            </div>
          </Card>
        )}
      </div>
