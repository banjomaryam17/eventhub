              ...
              {user && (
                <>
                  ...
                  {user.role.toLowerCase() === "admin" && (
                    <Link
                      href="/admin"
                      className="text-amber-400 hover:text-amber-300 text-sm px-3 py-2 rounded-xl hover:bg-amber-400/10 transition-colors"
                    >
                      Admin
                    </Link>
                  )}
          ...
          {menuOpen && user && (
            <div className="sm:hidden border-t border-slate-800 py-3 flex flex-col gap-1">
              ...
              <div className="border-t border-slate-800 mt-2 pt-2">
                <button
                  onClick={handleLogout}
                  className="text-sm text-red-400 hover:text-red-300 px-3 py-2 transition-colors w-full text-left"
                >
                  Logout
                </button>
              </div>
